...
bot.start(async (ctx) => {
    ...
    const menuMessage = `
<blockquote>⬡═――⊱ ⎧ ♱ 𝒲ℯ𝓁𝒸ℴ𝓂ℯ 𝒮ℐℒℰ𝒩𝒯 𝒦ℐℒℒℰℛ ♱ ⎭ ⊰―—═⬡</blockquote>
...
bot.action('/mainmenu', async (ctx) => {
    ...
    const menuMessage = `
<blockquote>⬡═――⊱ ⎧ ♱ 𝒲ℯ𝓁𝒸ℴ𝓂ℯ 𝒮ℐℒℰ𝒩𝒯 𝒦ℐℒℒℰℛ ♱ ⎭ ⊰―—═⬡
⸙ Developer : zhatanixx.t.me
⸙ Name Script : SILENT KILLER
⸙ Version : 1.2.310
⸙ Platfrom : telegraf 
...
[ created by zhatanixx ]</blockquote>`;
...
bot.action('/controls', async (ctx) => {
    const controlsMenu = `
<blockquote><b>─( 🕸 ) || 𝗧𝗛𝗘 𝗦𝗜𝗟𝗘𝗡𝗧 𝗞𝗜𝗟𝗟𝗘𝗥</b>
...
ᯓ /update - Auto Update Versi terbaru </blockquote>`;
...
ꜱᴇᴍᴜᴀ ᴍᴇɴᴜ ᴍᴜʀʙᴜɢ ɪɴɪ ʙᴇʙᴀꜱ ꜱᴘᴀᴍ ʏᴀᴋ ᴄᴏᴄᴏᴋ ʙᴜᴀᴛ ᴍᴜʀʙᴜɢ ᴅᴀɴ ꜱᴇɴᴅᴇʀ ɴᴏ ᴋᴇɴᴏɴ
#ᴘᴀɢᴇ 2/2</blockquote>
`;
...
bot.action('/about', async (ctx) => {
    const About = `
<blockquote>!! 𝙆𝙀𝙏𝙀𝙍𝘼𝙉𝙂𝘼𝙉 𝙒𝘼𝙅𝙄𝘽 𝘽𝘼𝘾𝘼 !!
───────────────────────────────────
✦ Script ini dibuat untuk tujuan untuk memberantas ripper atau penipu
 sistem payload “bug message”, spam stabil, dan exploit verifikasi
...
──────────────────────────────────────
© 2026 - 2027 @zhatanixx | All Rights Reserved</blockquote>
`;
...
⌑ /cekfunc - Use Chek Error Function</blockquote>`;
...
⌑ /cekidch - Check WhatsApp Channel ID</blockquote>`;
...
⌑ /bomb 
╰⪼ ɢᴀᴍᴇ'ꜱ ʙᴏᴍʙ ᴅᴜᴀʀ
zhatanixx ɴʏᴀ ᴄᴀᴘᴇᴋ, ɴᴇxᴛ ᴜᴘ ᴀᴊᴀ ᴅɪ ᴛᴀᴍʙᴀʜ ɪɴ</blockquote>
`;
...
⸙ Platfrom : telegraf 
╘═———————---———————═⬡
「 𝑺𝒖𝒑𝒑𝒐𝒓𝒕 𝑺𝒊𝒍𝒆𝒏𝒕 𝑲𝒊𝒍𝒍𝒆𝒓 」
⌑ @zhatanixx - The Developer
⌑ 𝒜ℒℒ ℬ𝒰𝒴ℰℛ 𝒮ℐℒℰ𝒩𝒯 𝒦ℐℒℒℰℛ
⌑ 𝒜ℒℒ 𝒪𝒲𝒩ℰℛ 𝒮ℐℒℰ𝒩𝒯 𝒦ℐℒℒℰℛ</blockquote>`;
...
ᯓ ᴏᴡɴᴇʀ     : 44k
ᯓ ᴛᴋ        : 59k
[x] ʙᴜʏ ꜱᴄʀɪᴘᴛ? ᴘᴠ ᴀᴅᴍɪɴ ᴅɪ ʙᴀᴡᴀʜ...</blockquote>`;
...
🎭 Role: ${role}
🏷️ Status: ${badge}
<blockquote>𝒫𝒪𝒲ℰℛℰ𝒟 ℬ𝒴 𝒵ℋ𝒜𝒯𝒜𝒩ℐ𝒳𝒳</blockquote>
`;
